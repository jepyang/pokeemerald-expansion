...
const u8 gText_BirchEnby[] = _("ENBY");
...
const u8 gText_DefaultNameJay[] = _("JAY");
...
const u8 gText_DefaultNameXan[] = _("XAN");
const u8 gText_DefaultNameSasha[] = _("SASHA");
const u8 gText_DefaultNameBlake[] = _("BLAKE");
const u8 gText_DefaultNameCam[] = _("CAM");
